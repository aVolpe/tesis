...
el advenimiento de las computadoras \fixme{esta brecha}{que brecha} se redujo,
...
su aplicabilidad en \fixme{áreas que no pueden ser cubiertas por otras
    alternativas}{Es cierto? mejor no decir eso}, como son:
...
\begin{description}
    ...
    \item[Eliminación de distancias] Con el \fixme{advenimiento}{No repetir
            mucho} de las computadoras y los satélites, el mundo se ha
    ...
    \item[Motivación para aprender] Las \Gls{tic} tienen un impacto positivo en
        ...
        \observacion{No usar tantos parentesis, re-ordenar}.
...
\fixme{En 1973 Vint Cerf creo el protocolo TCP/IP y es considerado el nacimiento
    de Internet\cite{white:ict}, lo que permitió que la información pueda ser
    transmitida de manera más sencilla, tiempo después con la aparición de las
    computadoras personales en 1977\cite{white:ict}. }{Conectar más parrafos
    osino parece que estan citando nomas, reordenar}
