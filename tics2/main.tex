...
\input{tics2/tradicional}
\input{tics2/tics}
\input{tics2/problemas}
\input{tics2/construccionismo}
\input{tics2/simulacion}
\input{tics2/gamification}
\input{tics2/juegos_serios}
\input{tics2/desarrollo_juegos_serios}
\input{tics2/actualidad}
