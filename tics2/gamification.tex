...
\begin{itemize}
    \item \fixme{Objetivos bien definidos}{explicar más}.
    ...
    \item Libertad de elección de método para realizar la
        tarea.\revisar{Abstracto}
    \item Enseñanza y retroalimentación constante\revisar{Repetitivo?}.
\end{itemize}
...
A continuación \fixme{mapeamos}{?} como se implementarían estos conceptos con los elementos
