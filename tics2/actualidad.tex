...
La relación de los \fixme{videojuegos}{Obs: en este punto ya no se entiende
    porque se termino hablando de videojuegos en otra seccion. Falta conectar
    mejor el "partimos de tics en edu", y el "terminaron hablando de
    videojuegos"} con la formación surge en los años $90$ y ha llegado hasta la
actualidad en plena efervescencia, siendo aplicados en casi todos los ámbitos de
la educación tanto formal como no formal. Los \fixme{juegos serios}{Otra seccion
    de juego serios en paralelo a los demas secciones que no tienen que ver con
    juegos serios, (reorganizar)} para el entrenamiento de habilidades se pueden
