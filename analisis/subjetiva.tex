...
\cmidrule(lr){2-5}
Alumno &
\matitle{2.5cm}{Facilidad de uso}  &
\matitle{3cm}{Funciones realizadas por los elementos del juego} &
\matitle{3cm}{Aleatoriedad para afianzar conocimientos} &
\matitle{2.5cm}{Aleatoriedad para representar realismo} \\
\midrule
1                     & 2             & 6             & 5             & 6  \\
2                     & 6             & 6             & 4             & 6  \\
3                     & 3             & 3             & 5             & 5  \\
...
\cmidrule(lr){3-5}
\matitle{2cm}{Alumno} &
\matitle{2cm}{Acciones con los elementos} &
\matitle{2cm}{Movimientos oculares} &
\matitle{2cm}{Reacción verbal} &
\matitle{2cm}{Movimientos motrices} &
\matitle{2cm}{Distinción entre los estados} \\
\midrule
1  & 6 & 6 & 2 & 5 & 2  \\
2  & 4 & 5 & 5 & 6 & 4  \\
3  & 5 & 3 & 3 & 3 & 3  \\
...
\cmidrule(lr){2-5}
Alumno &
\matitle{2.5cm}{Importancia del puntaje} &
\matitle{3cm}{Socialización de los puntajes} &
\matitle{3cm}{Medición del tiempo} &
\matitle{2.5cm}{Motivación del puntaje} \\
\midrule
1  & 6 & 4 & 4 & 7  \\
2  & 7 & 4 & 6 & 6  \\
3  & 6 & 6 & 5 & 6  \\
...
\cmidrule(lr){2-4}
Alumno &
\matitle{4cm}{Interacción con el paciente} &
\matitle{4cm}{Provee facilidades para el estudio} &
\matitle{4cm}{Complementa el estudio en clase y laboratorio} \\
\midrule
1  & 7 & 5 & 7  \\
2  & 6 & 6 & 6  \\
3  & 6 & 6 & 6  \\
...
\cmidrule(lr){2-4}
Alumno &
\matitle{4cm}{Representación iconográfica de conceptos y acciones en la \Gls{gui}}  &
\matitle{4cm}{Retroalimentación suficiente respecto a los pasos realizados} &
\matitle{4cm}{Detalles de los pasos realizados incorrectamente} \\
\midrule
1  & 3 & 2 & 7  \\
2  & 5 & 4 & 6  \\
3  & 3 & 6 & 6  \\
...
\cmidrule(lr){2-4}
Alumno &
\matitle{4cm}{Acciones a través de botones} &
\matitle{4cm}{Retroalimentación limitada} &
\matitle{3cm}{Potencial para comprender el procedimiento} \\
\midrule
1  & 6 & 6 & 6  \\
2  & 6 & 6 & 7  \\
3  & 4 & 6 & 6  \\
...
\begin{figure}[H]
\centering
\begin{tikzpicture}[label distance=.15cm,thick,scale=0.7, every node/.style={transform shape}]
