...
La escala de \textit{Likert} que es una métrica utilizada en la \emph{Encuesta subjetiva}
y en la encuesta correspondiente a la \emph{Prueba de interfaz de usuario}. Por
otra parte se describe también en que consiste la correlación de \textit{Pearson},
métrica que es utilizada para medir el grado de relación entre variables de las
encuestas realizadas, registros de actividades, entre otros.
