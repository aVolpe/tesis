...
\begin{overprint}
    \onslide<1|handout:1> \includegraphics[width=\textwidth, height=5.5cm]{../problema/iab_sala_3.jpg} 
    \onslide<2|handout:0> \includegraphics[width=\textwidth, height=5.5cm]{imagenes/practica_campo.jpg} 
\end{overprint}
...
\frametitle{\pagetitle}
\framesubtitle{Propuesta de solución}
% TODO no debería tener otro nombre?
