...
alumnos\cite{iab:tesis_alumnos}, \fixme{comentarios}{Usar otro termino} de los
profesores y \fixme{opiniones}{Usar otro termino} de alumnos egresados.
...
deben ser tomadas como experiencias de los mismos, \fixme{no representan un
    compendio de todos los problemas del \Gls{iab}}{Más bien habría que usar un
    termino más suave (esto estaba en negrita)}.
...
Desde \fixme{el factor humano}{Reformular}, los alumnos tienen varios
inconvenientes para asistir a clases, los principales inconvenientes
son\cite{iab:tesis_alumnos}:

\observacion{Esforzarse a lo que los prácticas se refiere}

\begin{itemize}
    \item \textbf{Carga horaria de trabajos prácticos}, se refiere al tiempo necesario
        por los estudiantes para llevar a cabo un trabajo práctico\revisar{?}. 
...
\fixme{Según~\cite{humphreys2013developing}, la enfermería es una profesión que
    atrae a alumnos del tipo divergente\footnote{Son aquellos que aprenden mejor
        ...
        experimentado.}, indicando así que las materias teóricas donde no existe
    una experimentación activa, por consiguiente, este tipo de enseñanza es
    menos productiva que la experimentación en laboratorios, campos de práctica,
    etc.}{Esto es importante pero quedo apocado entre toda la demás información,
    que parece de más.}.

Otro problemas \fixme{reportados}{Extraída de las entrevistas con } por
...
\begin{itemize}
    \item \textbf{Falta de preparación de los alumnos}, ciertos detalles necesarios para
        ...
        laboratorio\revisar{Cuando disminuye el ruido de la info anterior, esto
            se va a destacar más}.
    \item \textbf{Definición de un protocolo de comunicación}, en la práctica de campo,
        ...
        durante la práctica\revisar{Estos problemas puede ser atacados por su
            solución}.
    \item \textbf{Nerviosismo ante primera práctica}, ciertos alumnos reaccionan de
        ...
        experiencias\revisar{Estos problemas puede ser atacados por su
            solución}.
\end{itemize}

\pregunta{Estos son comentarios realizados por profesores, no se si pueden ir
    aquí, o como se deben citar. Respetas: lo ideal sería tener las fichas de
    las entrevistas como anexo, pero la gente no le gusta aparecer sin permiso}
