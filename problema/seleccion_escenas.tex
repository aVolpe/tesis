...
Uno de los procedimientos \fixme{mas comunes}{repetir menos} para tomar muestras
de sangre es la punción venosa, uno de los procedimientos invasivos \fixme{mas
    frecuentes}{repetir menos} en los hospitales, pues ofrece un medio directo
de acceso al sistema vascular para múltiples procesos diagnósticos y
terapéuticos.

\observacion{Enumerar motivos.}
...
\observacion{(Párrafo anterior) A su vez estos criterios tienen que estar bien
    definidos en la sección anterior}

\observacion{Falta describir un poco el ejercicio sin que se confunda con los
    criterios}
...
\item Informar al paciente acerca del procedimiento que va a ser
    realizado\revisar{?}.
\item Preparar materiales para la técnica aséptica\revisar{?}.
\item Lavado de manos\revisar{?}.
\item Vestirse con chaleco estéril, tapaboca, gorro y calzarse
    guantes\revisar{?}.
\item Realizar campo, dejar secar\revisar{?}.
\item Punzar, extraer $10mm$ de sangre, comprimir zona de punción.
\item \fixme{Cambiar la aguja}{Si son criterios, se debe usar otro lenguaje, por
        ejemplo: Cambio de agujas (XXX acciones)}.
