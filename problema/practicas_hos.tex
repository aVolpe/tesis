...
\fixme{Las prácticas de campo son aquellas prácticas profesionales que son
    ...
    las prácticas de laboratorio.}{Mover arriba al inicio de la sección}.

\observacion{Falta un conector}

Los alumnos del \Gls{iab} participan \fixme{en prácticas de campo}{Unificar
    termino} en diferentes hospitales dependiendo de las necesidades de cada
...
que un alumno ha adquirido la \fixme{pericia}{?} necesaria para una asignatura solo sí pudo
completar la planilla del instructor de dicha asignatura. Son registradas todas
las actividades del alumno, pero solo \fixme{cuentan}{se toman en cuenta (o
    alguna otra manera)} para el progreso final aquellas que son realizadas con
...
\observacion{En general me da la impresión de que se puede compactar un poco más
    estas secciones}
