...
\fixme{Se realizaron}{El tiemo} varias reuniones con la coordinadora de la carrera de Licenciatura
...
cantidad de procedimientos de enfermería existentes es muy alta \fixme{e
    incluirlos todos}{, lo que} a la solución está fuera del alcance de este
...
\begin{itemize}
    ...
    implementar la simulación, complejidad \fixme{que escapa al alcance del
        presente trabajo.}{Flecha apunta a donde dice \enquote{es muy alta
            (arriba)}}
...
\item \textbf{Deben ser difíciles de representar con realismo en un aula o
    ...
    \observacion{Existen casos inuides?}
