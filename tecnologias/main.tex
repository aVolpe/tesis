...
Luego de definir los requerimientos y el alcance \fixme{que tener}{es
    fundamental revisar las tecnologías} \fixme{la solución propuesta se
...
\fixme{Entrando un poco más en detalle}{} dentro de la implementación de la solución, se describen 
...
\fixme{La tecnología necesaria debe permitir crear escenarios en tres dimensiones,
...
comunicación, audio, etc.}{Esto no debería ir en frontend?}
...
La \fixme{cantidad}{El tiempo tota por práctica} de tiempo utilizado, cantidad
