%! TEX root = ../main.tex
\section{Selección de motor de videojuegos}
\label{sec:seleccion_plataforma}

En esta sección se comparan los motores de videojuegos \textit{Unreal Engine,
    CryEngine, Blender Game Engine, ShiVa3D y Unity3D} \fixme{según unos
    criterios de selección que serán citados a continuación}{Explicar en que se
    basan}. Estos criterios están relacionados con los requisitos que debe
cumplir la solución.
