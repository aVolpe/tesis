...
\fixme{Este proceso}{Que proceso?} se compone de varios pasos necesarios, para
...
\fixme{tesis}{Referirse siempre de una forma trabajo o lo que sea} fue realizado
...
\observacion{Cambiar los siguientes subsubsection por itemize (hasta desarrollo
    del backend)}
