...
%
%\begin{itemize}
%    \item Falta de tiempo: problemas de transporte y una carga de trabajos
%        prácticos alta dificultan las obligaciones académicas, como el estudio
%        de las materias.
%    \item Escasa personalización: la cantidad de alumnos
%    \item Evaluación subjetiva:
%    \item 
%
%\end{itemize}
%
...
%\item Reducida carga horaria para el estudio de las materias teóricas debido a
%    las prácticas.
...
%\item Alta cantidad de alumnos, debido a esto las prácticas de campo rara vez se
%    realizan en un sólo hospital y son realizadas por grupo de alumnos.
%\end{itemize}

%\subsection{Propuesta de solución}

%Los enfermeros son profesionales que requieren un alto grado de prácticas, y en
%la actualidad se presentan los problemas citados anteriormente en su formación.
%En este trabajo se propone el desarrollo de un juego serio, que incluye la
%simulación de laboratorios virtuales, como una herramienta de apoyo al proceso
%de aprendizaje de los alumnos de la carrera de Licenciatura en Enfermería.
