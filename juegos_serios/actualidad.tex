\section{Actualidad}
\observacion{Debería estar más atras}

La relación de los juegos con la \fixme{formación}{Aprendizaje, educación?
    Unificar.} surge en los años $90$ y ha llegado hasta la actualidad en plena
...
\observacion{Enumerar o bullets, no ace falta subsubsection}
...
\observacion{Reordenar:
\begin{itemize}
    \item Reordenar para que actualidad quede al final
    \item Explicar bien concepto
    \item Ejemplos
    \item Actualidad
\end{itemize}}
