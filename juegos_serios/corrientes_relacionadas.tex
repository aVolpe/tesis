...
%
%Para ejecutar un motor de reglas del tipo \gls{eca}, se deben tener en cuenta
%dos factores, 
...
%
%El modo inmediato es ideal para la evaluación de un juego serio, 
%pues permite un acceso completo al contexto.
