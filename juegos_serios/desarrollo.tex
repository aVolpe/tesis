...
Una vez definido lo que es un juego serio, queda la tarea de definir como
realizar uno, que factores deben ser tomados en cuenta y como encarar los
...
\item \textbf{Implementación técnica}: se refiere a la actividad de programación
    ...
    elementos de diseño en el juego. 
...
Estas dimensiones no pueden ser consideradas individualmente, todas estas
...
\textit{Pereira}\cite{pereira2009design} en el diseño del juego \emph{Living
...
\begin{enumerate}
\item \textbf{Objetivos de diseño:} definen cuál es el propósito del juego, donde
...
\item \textbf{Competencias básicas relacionadas con la educación:} se identifican
    aquellas que influyen en el diseño del juego, se definen los conocimientos
...
\item \textbf{Tiempo de juego:} el primer factor que se debe estudiar es el
    ...
    juego, este tiempo debe ser analizado por separado a la hora de realizar un
...
\item \textbf{Representación e interacción:} representación se refiere a como se
    visualiza el entorno, e interacción como se relaciona el jugador con su
    entorno.
...
\item \textbf{Implementación:} en esta etapa se estudia el estado del arte de las
    plataformas tecnológicas disponibles para el desarrollo del juego, se toman
...
\item \textbf{Evaluación:} durante el desarrollo del juego serio, se deben
    ...
    expertos y miembros de la audiencia objetivo. Así mismo, se debe realizar
    evaluaciones con los grupos de interés las cuales se centra en la adaptación
    del juego (usabilidad). 
