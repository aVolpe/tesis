...
la enseñanza y desarrollo de profesionales\revisar{Alguna referencia?}, por que
...
\emph{E-Learing} es su enfoque, \fixme{en la}{tal se enfoca en} creación de una
experiencia de aprendizaje significativo, relevante y atractivo. \revisar{Y
    otra.}En un \emph{Juego Serio} existen metas claras de aprendizaje pero las
...
\subsection{Ventajas}
\observacion{Sintetizar en partes}

Las \Gls{tic} y los juegos serios en particular son herramientas de
\fixme{inestimable}{simplificar} valor para apoyar los nuevos procesos de
...
\subsection{Desafíos}
\observacion{Bullets bullets bullets}
