\section{Descripción de los juegos serios}
...
\emph{E-Learning}, esta en el enfoque que tienen los juegos serios en la creación
...
Es importante notar que los juegos deben ser elaborados teniendo en cuenta el
...
\item \textbf{Falta de investigación}: aunque en los últimos años los estudios
    ...
    necesarios más estudios para privar su eficiencia\cite{sg:aoverview}.
...
\item \textbf{Expectativas muy altas}: un juego serio, como el resto de la
    ...
    solo, un juego acerca de hábitos saludables, no hará del jugador un
    nutricionista, pero si permiten al jugador explorar las opciones, tener en
...
\item \textbf{Falta de recursos}: uno de los factores más complicados a la hora
    ...
    presupuesto insignificante\cite{stapleton2004serious,sg:aoverview}. Como
