...
\newcommandx{\replantear}[2][1=]{\todo[inline,caption={Replantear}]{#2}}
\newcommandx{\observacion}[2][1=]{\todo[inline,caption={Observacion}]{#2}}
\newcommandx{\revisar}[2][1=]{\todo[caption={Revision},linecolor=red,backgroundcolor=white,#1]{#2}}
