...
\cmidrule(lr){2-3} 
\begin{minipage}{3cm}Número de alumno\observacion{\#alumno o ver mejor forma de
        decir que es uno  por fila}  \end{minipage} & 
Sesiones jugadas & 
\begin{minipage}{3cm}Tiempo jugado \observacion{Tiempo en segundos}\end{minipage}\\
\midrule
 1       & 5  & 1202 \\
 2       & 19 & 2507 \\
 4       & 5  & 398  \\
