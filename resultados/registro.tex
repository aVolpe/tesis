...
\observacion{#alumno o ver mejor forma de decir que es uno por fila}
\observacion{Tiempo en segundos?}
\end{table}
...
puntajes\revisar{Esto contradice lo anterior}\revisar{Donde esta la
    de extracción(??)}.
