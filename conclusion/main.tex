...
%\input{conclusion/disenho}
%\input{conclusion/desarrollo}
%\input{conclusion/evaluacion}
\input{conclusion/version2}
%\input{conclusion/factores}
%\input{conclusion/recomendaciones}
%\input{conclusion/otras}
